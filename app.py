...
احذر من كتابة جمل ناقصة او تضع نقاط ... من غير تكوين جمل مفهومة
...
في ال content يجب ان تشير على توقعاتك بناء على المصادر و تسرد مجموعة توقعات قيمة و بناءة تلك التوقعات تكون بناء على المصادر و تاخذ في حسبانك جميع الجوانب السياسية و الاجتماعية و الدينية و الاقتصادية مع ذكر خطوات خاصة لتلك القضية ليست عامة ستتطبعها تلك الجهة السياسية المصرية الصادر اليها التقرير 
