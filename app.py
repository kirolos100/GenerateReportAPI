...
يجب ان كل  content يحتوي من خمس لسبع فقرات كبار و طوال مليئين بالتفاصيل الغنية 
برهن ودلل على المحتوى في الـ content بالمعلومات المستندة إلى المصادر، مع استخدام إحصائيات وأرقام مستخرجة منها. يمكنك أن تشير إلى المصدر بذكر اسم المصدر المستخدم فلا "حسب ذلك المصدر" فقط بل اذكر اسمه او عنوانه  و بيانات عنه مثل تاريخ نشره و اسم الكاتب و عنوان المقال و اسم الموقع او الصحيفة اذا توفر اسمه فيكون ذلك لحفظ حقوق المصدر ثم تقدم البرهان المناسب.
لا تنسى ال tables اذا احتاج الامر في ال content
في ال content يجب ان تشير على توقعاتك بناء على المصادر و تسرد مجموعة توقعات قيمة و بناءة تلك التوقعات تكون بناء على المصادر و تاخذ في حسبانك جميع الجوانب السياسية و الاجتماعية و الدينية و الاقتصادية مع ذكر خطوات خاصة لتلك القضية ليست عامة ستتطبعها تلك الجهة السياسية الصادر اليها التقرير او اي من الجهات المعنية بهذا التقرير
...
توقعاتك يجب ان تكون فيها رأي مبرهن بالمصادر مع تواريخ و ارقام و احصائيات و قل انها المتوقعة 
برهن ودلل على المحتوى في الـ content بالمعلومات المستندة إلى المصادر، مع استخدام إحصائيات وأرقام مستخرجة منها. يمكنك أن تشير إلى المصدر بذكر اسم المصدر المستخدم فلا "حسب ذلك المصدر" فقط بل اذكر اسمه او عنوانه  و بيانات عنه مثل تاريخ نشره و اسم الكاتب و عنوان المقال و اسم الموقع او الصحيفة اذا توفر اسمه فيكون ذلك لحفظ حقوق المصدر ثم تقدم البرهان المناسب.
 دائما اذكر رأيك مع امثلة هامة و مصطلحات سياسية مهمة تجعل من رايك راي مهم للعمل به و برهن على رايك من المصادر و لا تتكلم بشكل عام بل تكلم اكثر بشكل أخص
لا تنسى ان تزيد دائما توقعاتك و تنبؤاتك و رايك في ال content لكل نقطة مزودة بالارقام و التواريخ و الاحصائيات
"""
